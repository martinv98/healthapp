...
//  HealthAppTest
//
//  Created by Martin Varga on 26/05/2022.
//
...
private class PopUpWindowView: UIView {
    ...
    init() {
        ...
        // Popup Background
        popupView.backgroundColor = hexStringToUIColor(hex: "#BCB6FF")
        ...
        popupTitle.backgroundColor = hexStringToUIColor(hex: "745296")
        ...
        popupButton.backgroundColor = hexStringToUIColor(hex: "745296")
